...
module MessageVerifier
  class Verifier
    def initialize(@secret : String, @digest : Symbol = :sha1, @serializer : Symbol | ::Nil = nil)
    end
    ...
    def verified(signed_message, purpose : String | Symbol | ::Nil = nil)
      if valid_message?(signed_message)
        ...
        load(metadata.to_s) if metadata
      end
    rescue Base64::Error
      nil
    end
    ...
    def generate(message : String, expires_at : Time | ::Nil = nil, expires_in : Int64 | ::Nil = nil, purpose : String | Symbol | ::Nil = nil)
      data = encode(MessageVerifier::Metadata.wrap(dump(message), expires_at: expires_at, expires_in: expires_in, purpose: purpose))
